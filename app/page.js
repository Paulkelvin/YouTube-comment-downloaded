    ...
    <main className="mx-auto flex min-h-screen max-w-xl flex-col justify-center px-4 py-12">
      ...
      <form onSubmit={handleLookup} className="flex flex-col gap-3 sm:flex-row">
        <input
          ...
          disabled={isBusy}
          className="flex-1 rounded-lg border border-slate-300 px-4 py-2.5 text-sm shadow-sm focus:border-slate-500 focus:outline-none focus:ring-1 focus:ring-slate-500 disabled:bg-slate-100"
        />
        <button
          type="submit"
